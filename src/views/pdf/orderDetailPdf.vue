  ...
  <div class="pageA4">
    ...
    <div style="margin-top: 50px">
      ...
      <div class="normal" style="margin-bottom: 20px">
        <span class="time-text text-left">用户编号: 11111</span>
        <span class="time-text text-left">姓名/电话: 111111111111111,1111</span>
      </div>
      <div class="normal" style="margin-bottom: 20px">
        <span class="time-text text-left">邮箱: hdsjdskdjksdjskds@qq.com</span>
        <span class="time-text text-left">支付/收获方式: 在线支付 送货上门</span>
      </div>
      <div class="normal" style="margin-bottom: 20px">
        <span class="time-text text-left">联系电话: 122333333</span>
        <span class="time-text text-left">收货地址: bjdbcdcdnxxcxcnxcnjdcsdfdshhjjjjjj</span>
      </div>
    </div>
    ...
    <div>
      ...
      <div style="margin-bottom: 20px; border-bottom: 1px solid #ccc; padding: 5px 0">
        ...
        <span style="width: 50%; display: inline-block; text-align: right">111</span>
      </div>
      <div style="margin-bottom: 20px; border-bottom: 1px solid #ccc; padding: 5px 0">
    ...
    <div class="spacing">
      <span style="display: inline-block; width: 20%">积分抵扣: 111</span
      ><span style="display: inline-block; width: 20%">集运券抵扣: 111</span
      ><span style="display: inline-block; width: 20%">超长费: 1111</span
      ><span style="display: inline-block; width: 20%">地址附加费: 111</span
      ><span style="display: inline-block; width: 20%">运单附加费: 1111</span>
    </div>
    <div class="spacing">
      <span style="display: inline-block; width: 20%">积分抵扣: 111</span
      ><span style="display: inline-block; width: 20%">集运券抵扣: 111</span
    ...
    <div style="margin-bottom: 20px; padding: 5px 0">
      <span style="width: 50%; display: inline-block">订单运费</span>
      <span style="width: 50%; display: inline-block; text-align: right">111</span>
    </div>
    <div style="margin-bottom: 20px; padding: 5px 0">
      <span style="width: 50%; display: inline-block">费用总计</span>
      <span style="width: 50%; display: inline-block; text-align: right">111</span>
    </div>
    <div style="margin-bottom: 20px; padding: 5px 0">
      <span style="width: 50%; display: inline-block">实付费用</span>
      <span style="width: 50%; display: inline-block; text-align: right">111</span>
    </div>
