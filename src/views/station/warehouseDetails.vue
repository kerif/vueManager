<template>
  <div class="warehouse-self-details">
    <div>
   ...
   v-loading="tableLoading">
      ...
      <!-- 体积重量 -->
       <el-table-column :label="'体积重量' + this.localization.weight_unit" prop="volume_weight"></el-table-column>
      <!-- 尺寸（长宽高cm） -->
...
export default {
  ...
  methods: {
    getList () {
      ...
      this.$request.getAloneSelf(this.$route.params.id).then(res => {
