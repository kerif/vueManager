<template>
  <div class="logistics-container">
    ...
    @selection-change="selectionChange">
      ...
      <el-table-column :label="$t('快递公司')" prop="logistics_company">
      </el-table-column>
      ...
      <el-table-column :label="$t('操作')" width="260">
        <template slot-scope="scope">
          <!-- 轨迹 -->
          <el-button class="btn-green" @click="editWarehouse(scope.row.id, scope.row.logistics_sn)">{{$t('轨迹')}}</el-button>
          <!-- 删除 -->
...
export default {
  ...
  methods: {
    getList () {
      ...
      this.$request.getCustomLogistics({
