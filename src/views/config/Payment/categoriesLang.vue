  ...
  <div class="categories-lang">
    ...
    <el-form label-position="top" :model="params" ref="ruleForm" class="demo-ruleForm">
      <el-form-item :label="$t('*分类名称')">
        <el-row>
          <el-col :span="10">
            <el-input :placeholder="$t('请输入内容')" v-model="params.name"></el-input></el-col>
        </el-row>
      </el-form-item>
      <!-- 邮件标题 -->
      <el-form-item :label="$t('*标题')">
        <el-row>
          <el-col :span="10">
            <el-input :placeholder="$t('请输入内容')" v-model="params.risk_warning_title"></el-input></el-col>
        </el-row>
      </el-form-item>
      <!-- 邮件内容 -->
...
export default {
  ...
  methods: {
    getList () {
      this.$request.categoriesLang(this.line.id, {
