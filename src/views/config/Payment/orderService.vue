<template>
  <div class="order-service">
    ...
    <el-table :data="valueData" v-loading="tableLoading" class="data-list" border stripe>
      ...
      <el-table-column :label="$t('操作')" width="140px">
        <template slot-scope="scope">
          <el-button class="btn-dark-green" @click="editService(scope.row.id)">{{
            $t('编辑')
          }}</el-button>
          <el-button class="btn-light-red" @click="deleteService(scope.row.id)">{{
            $t('删除')
          }}</el-button>
        </template>
      </el-table-column>
    ...
    >
      ...
      <el-table-column :label="$t('保险金额')">
        <template slot-scope="scope">
          <span v-if="scope.row.insurance_type === 1"> {{ scope.row.insurance_proportion }}% </span>
    ...
    >
      ...
      <el-table-column :label="$t('操作')" width="140px">
        <template slot-scope="scope">
          ...
          <!-- 删除 -->
          <el-button class="btn-light-red" @click="deleteTariff(scope.row.id)">{{
            $t('删除')
          }}</el-button>
        </template>
      </el-table-column>
