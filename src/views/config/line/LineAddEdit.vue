  ...
  <div class="line-add-container">
    <el-form label-position="top" :model="form" ref="form">
      ...
      <el-form-item>
        ...
        <el-row>
          <el-col :span="10">
            <el-input v-model="form.reference_time" :placeholder="$t('例512工作日日')"></el-input>
          </el-col>
        </el-row>
      </el-form-item>
      <!-- 取消包裹重量限制 -->
          ...
          <el-col :span="10">
            <div>
              ...
              <el-tooltip
                class="item"
                effect="dark"
                :content="$t('当包裹重量不足最小重量时按最小重量来计算。')"
                placement="top"
              >
          ...
          <el-col :span="10">
            <div>
              ...
              <el-tooltip
                class="item"
                effect="dark"
                :content="$t('仅对多箱出库时生效关闭按统一的重量计算价格')"
                placement="top"
              >
                <span class="el-icon-question icon-info"></span>
              </el-tooltip>
          ...
          <el-col :span="10">
            <div>
              ...
              <el-tooltip
                class="item"
                effect="dark"
                :content="$t('订单多箱打包时每个打包箱重量分别上浮而不是整个上浮')"
                placement="top"
              >
                <span class="el-icon-question icon-info"></span>
              </el-tooltip>
          ...
          <el-col :span="10">
            <div>
              ...
              <el-tooltip
                class="item"
                effect="dark"
                :content="$t('主要用于计算包裹体积重量5000或6000如长高宽系数')"
                placement="top"
              >
                <span class="el-icon-question icon-info"></span>
              </el-tooltip>
        ...
        <el-form-item>
          <div>
            ...
            <el-tooltip
              class="item"
              effect="dark"
              :content="$t('在满足免抛条件情况下不考虑体积重仅以实重计费')"
              placement="top"
            >
              <span class="el-icon-question icon-info"></span>
            </el-tooltip>
