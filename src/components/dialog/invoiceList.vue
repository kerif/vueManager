  ...
  >
    <el-form :model="form" ref="form" :rules="rules" class="form-box" label-width="180px">
      ...
      <div v-if="showOption">
        ...
        <div class="invoice-title">{{ $t('默认发件人') }}</div>
        <el-row :gutter="20">
          <el-col :span="10">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="10">
            <el-form-item label="Postcode">
              <el-input v-model="form.sender_info.postcode" placeholder="请输入Postcode"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <div class="invoice-title">{{ $t('其他信息') }}</div>
        <el-row :gutter="20">
          <el-col :span="10">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="Supplier Customs Code">
              <el-input
                v-model="form.extra_info.supplier_customer_code"
